...
nao_max = 19
graph_data_path = './'
hsxdump_path = '/public/home/zhongyang/Tools/Honpos/hsx_read/hsxdump'
max_SCF_skip = 95 # default is 200
#scfout_paths = ["/public/home/wbchu/cwzhang/GaAs/bench/scf/{:d}".format(i) for i in range(55,100)]
scfout_paths = glob("./data/*/")

dat_file_name = "TiO2.fdf"
std_file_name = "TiO2.out"
scfout_file_name = "TiO2.HSX"
...
#        assert os.path.isfile(os.path.join(scf_path, 'overlap.HSX'))
    ...
    try:
        with open(f_std, 'r') as f:
            ...
            Enpy = float(pattern_eng_siesta.findall((content).strip())[0][-1])
    except:
